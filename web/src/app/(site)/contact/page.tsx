  ...
  return (
    <div className="content-canvas">
      <header className="grid gap-10 py-16 md:grid-cols-[minmax(200px,1fr)_2fr] md:grid-rows-[auto_1fr] md:py-24">
        ...
        <Image src="/system-network1.png" alt="Connected automation workflow diagram" width={512} height={286} sizes="(max-width: 767px) calc(100vw - 40px), 320px" priority className="h-auto w-full max-w-[320px] md:col-start-1 md:row-start-2 md:self-end" />
      </header>
